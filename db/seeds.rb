...
Rate.create!([
  {id: 1, shop_id: 1, title: "Free Local Delivery", description: "Delivered 10am - 4pm.", delivery_method: "delivery", price: 0, cutoff_time: 15, cook_time: "morning", delivery_type: "next_day", min_grams: nil, max_grams: nil, min_price: nil, max_price: nil, price_weight_modifier: 0.0, code: nil, notes: nil, price_weight_modifier_starter: 0},
