...
Rate.create!([
  ...
  {id: 5, shop_id: 1, title: "Free Delivery for Subscribers", description: "Delivered before 9am.", delivery_method: "delivery", price: 0, cutoff_time: 11, receive_window: "before 9am", delivery_type: "subscription", min_grams: nil, max_grams: nil, min_price: nil, max_price: nil, price_weight_modifier: 0.0, code: nil, notes: nil, price_weight_modifier_starter: 0},
