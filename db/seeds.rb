...
Rate.create!([
  {id: 1, shop_id: 1, title: "Free Local Delivery", description: "Delivered 10am - 4pm.", delivery_method: "delivery", price: 0, cutoff_time: 15, cook_time: "afternoon", delivery_type: "next_day", min_grams: nil, max_grams: nil, min_price: nil, max_price: nil, price_weight_modifier: 0.0, code: nil, notes: nil, price_weight_modifier_starter: 0},
  {id: 2, shop_id: 1, title: "Same Day Delivery", description: "Delivered 4 - 8pm.", delivery_method: "delivery", price: 500, cutoff_time: 11, cook_time: "morning", delivery_type: "same_day", min_grams: nil, max_grams: nil, min_price: nil, max_price: nil, price_weight_modifier: 0.0, code: nil, notes: nil, price_weight_modifier_starter: 0},
  {id: 3, shop_id: 1, title: "Store Pickup", description: "Pickup availability only during store hours.", delivery_method: "pickup", price: 0, cutoff_time: 15, cook_time: "morning", delivery_type: "next_day", min_grams: nil, max_grams: nil, min_price: nil, max_price: nil, price_weight_modifier: 0.0, code: nil, notes: nil, price_weight_modifier_starter: 0},
  {id: 4, shop_id: 1, title: "Super Fast Delivery", description: "Delivered before 9am.", delivery_method: "delivery", price: 1500, cutoff_time: 15, cook_time: "afternoon", delivery_type: "next_day", min_grams: nil, max_grams: nil, min_price: nil, max_price: nil, price_weight_modifier: 0.0, code: nil, notes: nil, price_weight_modifier_starter: 0},
