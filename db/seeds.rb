...
PickupLocation.create!([
  {shop_id: 1, title: "Bamboo Juices", address: "502 Toombs St.", days_available: ["2", "3", "4"]}
])
BlackoutDate.create!([
  {shop_id: 1, title: "Christmas", blackout_date: "2017-12-25 00:00:00"},
  {shop_id: 1, title: "Labor Day", blackout_date: "2017-09-04 00:00:00"},
  {shop_id: 1, title: "Work Retreat", blackout_date: "2017-07-31 00:00:00"}
])
Rate.create!([
  ...
  {shop_id: 1, title: "FedEx Ground", description: "get your juice anywhere!", delivery_method: "shipping", price: 1953, cutoff_time: 15, cook_time: "N/A", delivery_type: "next_day", min_grams: nil, max_grams: nil, min_price: nil, max_price: nil, price_weight_modifier: 0.0, code: nil, notes: nil, price_weight_modifier_starter: 0},
  {shop_id: 1, title: "FedEx Priority Overnight", description: "get your juice anywhere, and FAST!", delivery_method: "shipping", price: 7000, cutoff_time: 15, cook_time: "N/A", delivery_type: "next_day", min_grams: nil, max_grams: nil, min_price: nil, max_price: nil, price_weight_modifier: 0.0, code: nil, notes: nil, price_weight_modifier_starter: 0}
])
